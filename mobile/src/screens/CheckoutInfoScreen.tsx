...
const st = StyleSheet.create({
  ...
  eyebrow: { color: colors.orange, fontSize: 10, fontWeight: '700', letterSpacing: 0.3 },
  ...
  eventTitle: { color: '#F8FAFC', fontSize: 18, fontWeight: '900', marginBottom: 4 },
  ...
  summaryLabel: { flex: 1, color: 'rgba(226,232,240,0.85)', fontSize: 13, fontWeight: '700' },
  summaryPrice: { color: '#F8FAFC', fontSize: 14, fontWeight: '900' },
  ...
  formTitle: { color: '#F8FAFC', fontSize: 16, fontWeight: '900', marginBottom: 2 },
  ...
  prefillVal: { color: '#F8FAFC', fontWeight: '700' },
  field: { gap: 6 },
  ...
  continueBtnText: { color: '#FFFFFF', fontSize: 15, fontWeight: '900', letterSpacing: 0.3 },
