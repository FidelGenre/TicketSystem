...
const styles = StyleSheet.create({
  ...
  backButton: { minHeight: 38, borderRadius: 8, borderWidth: 1, borderColor: 'rgba(255,255,255,0.12)', paddingHorizontal: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,255,255,0.035)' },
  backText: { color: '#FFFFFF', fontWeight: '700', fontSize: 13 },
  soundButton: { minHeight: 38, minWidth: 100, borderRadius: 8, paddingHorizontal: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: '#0A375A' },
  ...
  badge: { marginTop: 24, alignSelf: 'flex-start', minHeight: 42, borderRadius: 8, backgroundColor: '#0A375A', paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', gap: 8 },
  badgeIcon: { color: '#FFFFFF', fontSize: 14, fontWeight: '700' },
  badgeText: { color: '#FFFFFF', fontSize: 11, fontWeight: '700', letterSpacing: 0 },
  title: { color: '#FFFFFF', fontSize: 30, lineHeight: 34, fontWeight: '700', marginTop: 14 },
  subtitle: { color: 'rgba(226,232,240,0.64)', fontSize: 13, lineHeight: 20, fontWeight: '400', marginTop: 8 },

  scannerCard: { marginTop: 22, borderRadius: 8, borderWidth: 1, borderColor: 'rgba(255,255,255,0.14)', backgroundColor: 'rgba(8,31,51,0.54)', overflow: 'hidden' },
  ...
  orangeButton: { minHeight: 56, borderRadius: 8, backgroundColor: '#F97316', paddingHorizontal: 28, alignItems: 'center', justifyContent: 'center', overflow: 'hidden', shadowColor: '#F97316', shadowOpacity: 0.20, shadowRadius: 14, shadowOffset: { width: 0, height: 8 }, elevation: 5 },
  ...
  inputShell: { minHeight: 56, borderRadius: 8, borderWidth: 1, borderColor: 'rgba(226,232,240,0.14)', backgroundColor: 'rgba(255,255,255,0.045)', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 14, gap: 10 },
  ...
  blueButton: { minHeight: 56, borderRadius: 8, backgroundColor: '#0A375A', alignItems: 'center', justifyContent: 'center' },
  blueButtonText: { color: '#FFFFFF', fontSize: 12, fontWeight: '700', letterSpacing: 0 },

  validationCard: { marginTop: 18, borderRadius: 8, borderWidth: 1, padding: 20, alignItems: 'center' },
  ...
  ticketDetails: { alignSelf: 'stretch', marginTop: 18, borderRadius: 8, borderWidth: 1, borderColor: 'rgba(255,255,255,0.12)', backgroundColor: 'rgba(8,31,51,0.62)', padding: 14 },
  ...
  nextButton: { alignSelf: 'stretch', minHeight: 48, borderRadius: 8, backgroundColor: '#F97316', alignItems: 'center', justifyContent: 'center', marginTop: 16 },
  nextButtonText: { color: '#FFFFFF', fontSize: 14, fontWeight: '700', letterSpacing: 0 },

  statsPanel: { marginTop: 22, borderRadius: 8, borderWidth: 1, borderColor: 'rgba(255,255,255,0.12)', backgroundColor: 'rgba(8,31,51,0.58)', padding: 16 },
  ...
  statsTitle: { color: '#FFFFFF', fontSize: 22, fontWeight: '700', marginTop: 6 },
  resetButton: { borderRadius: 8, borderWidth: 1, borderColor: 'rgba(255,255,255,0.12)', backgroundColor: 'rgba(255,255,255,0.045)', paddingHorizontal: 12, paddingVertical: 9 },
  resetText: { color: '#CBD5E1', fontSize: 10, fontWeight: '700', letterSpacing: 0 },
  statGrid: { marginTop: 16, gap: 10 },
  statCard: { borderRadius: 8, borderWidth: 1, borderColor: 'rgba(255,255,255,0.10)', backgroundColor: 'rgba(255,255,255,0.045)', padding: 14 },
  statOrange: { borderColor: 'rgba(249,115,22,0.20)', backgroundColor: 'rgba(249,115,22,0.10)' },
  statGreen: { borderColor: 'rgba(16,185,129,0.20)', backgroundColor: 'rgba(16,185,129,0.10)' },
  statLabel: { color: '#94A3B8', fontSize: 10, fontWeight: '400', letterSpacing: 0 },
  statLabelOrange: { color: '#FB923C' },
  statLabelGreen: { color: '#10B981' },
  statValue: { color: '#FFFFFF', fontSize: 32, fontWeight: '700', marginTop: 6 },
  statValueOrange: { color: '#F97316' },
  statValueGreen: { color: '#10B981' },
  capacityCard: { marginTop: 10, borderRadius: 8, borderWidth: 1, borderColor: 'rgba(255,255,255,0.10)', backgroundColor: 'rgba(255,255,255,0.045)', padding: 14, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  capacityLabel: { color: 'rgba(10,55,90,0.58)', fontSize: 10, fontWeight: '400', letterSpacing: 0 },
  capacityValue: { color: '#FFFFFF', fontSize: 30, fontWeight: '700', marginTop: 4 },
  capacityPercent: { color: 'rgba(10,55,90,0.62)', fontSize: 24, fontWeight: '700' },

  recentPanel: { marginTop: 22 },
  recentHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  recentTitle: { color: '#FFFFFF', fontSize: 18, fontWeight: '700' },
  recentClock: { color: '#F97316', fontSize: 22 },
  recentItem: { borderRadius: 8, borderWidth: 1, padding: 14, marginBottom: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 },
  recentValid: { borderColor: 'rgba(16,185,129,0.22)', backgroundColor: 'rgba(16,185,129,0.10)' },
  recentInvalid: { borderColor: 'rgba(239,68,68,0.22)', backgroundColor: 'rgba(239,68,68,0.10)' },
