...
const styles = StyleSheet.create({
  ...
  title: { color: '#F8FAFC', fontSize: 30, lineHeight: 34, fontWeight: '600', textAlign: 'center', marginBottom: 12 },
  ...
  infoTitle: { color: '#F8FAFC', fontSize: 17, fontWeight: '600', marginBottom: 2 },
  ...
  cardTitle: { color: '#F8FAFC', fontSize: 22, fontWeight: '600', marginBottom: 14 },
  ...
  successTitle: { color: '#86EFAC', fontSize: 20, fontWeight: '600', marginBottom: 8 },
  ...
  secondaryText: { color: '#F8FAFC', fontSize: 13, fontWeight: '600' },
});
