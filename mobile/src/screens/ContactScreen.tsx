...
const styles = StyleSheet.create({
  ...
  title: { color: '#FFFFFF', fontSize: 32, fontWeight: '700', marginBottom: 8 },
  ...
  secondaryText: { color: '#FFFFFF', fontSize: 13, letterSpacing: 0, fontWeight: '700' },
  ...
  infoLabel: { color: colors.orange, fontSize: 11, letterSpacing: 0, fontWeight: '700', marginBottom: 6 },
  infoValue: { color: '#FFFFFF', fontSize: 16, fontWeight: '700' },
});
