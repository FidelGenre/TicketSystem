...
const styles = StyleSheet.create({
  ...
  faqQ: { color: '#FFFFFF', fontSize: 16, fontWeight: '700', flex: 1 },
  faqToggle: { color: colors.orange, fontSize: 22, fontWeight: '700' },
  ...
  helpTitle: { color: '#FFFFFF', fontSize: 18, fontWeight: '700', marginBottom: 6 },
