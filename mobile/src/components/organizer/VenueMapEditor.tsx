...
const styles = StyleSheet.create({
  ...
  mapStatAvailable: {},
  mapStatLabel: { color: '#6B7280', fontSize: 9, fontWeight: '700' },
  mapStatValue: { color: colors.navy, fontSize: 11, fontWeight: '700' },
  ...
  brandEyebrow: { color: '#9CA3AF', fontSize: 9, fontWeight: '700' },
  brandTitle: { color: '#1f2937', fontSize: 13, fontWeight: '700' },
  capacityPill: { backgroundColor: '#eaf2ff', borderRadius: 10, paddingHorizontal: 9, height: 22, justifyContent: 'center' },
  capacityText: { color: '#2563eb', fontSize: 10, fontWeight: '700' },
  ...
  railZoomValue: { color: '#6B7280', fontSize: 9, fontWeight: '700' },
  toolText: { color: '#6B7280', fontSize: 9, fontWeight: '700' },
  ...
  inspectorTitle: { flex: 1, color: '#1f2937', fontSize: 12, fontWeight: '700' },
  iconButton: { color: colors.navy, fontSize: 10, fontWeight: '700' },
  deleteText: { color: '#ef4444', fontSize: 10, fontWeight: '700' },
  inspectorContent: { padding: 14, paddingBottom: 28 },
  sectionLabel: { color: '#4b5563', fontSize: 11, fontWeight: '700', letterSpacing: 0, marginTop: 10, marginBottom: 10 },
  ...
  smallStepperText: { color: colors.navy, fontWeight: '700' },
  numberInput: { flex: 1, textAlign: 'center', color: '#1f2937', fontSize: 12, fontWeight: '700' },
