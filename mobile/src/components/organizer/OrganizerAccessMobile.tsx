...
const styles = StyleSheet.create({
  ...
  quickTitle: { color: '#F8FAFC', fontSize: 16, fontWeight: '700', marginBottom: 4 },
  quickCopy: { color: 'rgba(226,232,240,0.64)', fontSize: 12, lineHeight: 18, fontWeight: '700' },
  ...
  quickButtonText: { color: '#FFFFFF', fontSize: 14, letterSpacing: 0, fontWeight: '700' },
  sectionTitle: { color: '#F8FAFC', fontSize: 18, fontWeight: '700', marginTop: 10, marginBottom: 12 },
  accessCard: {
    backgroundColor: '#030B14',
    borderRadius: 22,
    borderWidth: 1,
  ...
  iconText: { color: '#F8FAFC', fontSize: 14, fontWeight: '700' },
  accessMain: { flex: 1 },
  accessTitle: { color: '#F8FAFC', fontSize: 17, fontWeight: '700', marginBottom: 4 },
  accessType: { color: 'rgba(226,232,240,0.64)', fontSize: 13, fontWeight: '700' },
