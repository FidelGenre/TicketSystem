...
const styles = StyleSheet.create({
  ...
  quickTitle: { color: colors.textPrimary, fontSize: 16, fontWeight: '700', marginBottom: 4 },
  ...
  accessMain: { flex: 1 },
  accessTitle: { color: colors.textPrimary, fontSize: 17, fontWeight: '700', marginBottom: 4 },
  ...
  pauseText: { color: '#FFFFFF', fontSize: 14, letterSpacing: 0, fontWeight: '700' },
