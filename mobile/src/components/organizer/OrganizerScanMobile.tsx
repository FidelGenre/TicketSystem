...
const styles = StyleSheet.create({
  ...
  scanIcon: { width: 86, height: 86, borderRadius: 28, backgroundColor: colors.card, alignItems: 'center', justifyContent: 'center', marginBottom: 16 },
  scanIconText: { color: colors.textPrimary, fontSize: 38, fontWeight: '700' },
  scanTitle: { color: '#FFFFFF', fontSize: 24, fontWeight: '700', marginBottom: 8, textAlign: 'center' },
  ...
  statusBox: { width: '48%', backgroundColor: colors.cardSoft, borderRadius: 18, borderWidth: 1, borderColor: colors.goldBorder, padding: 14 },
  statusValue: { color: colors.orange, fontSize: 22, fontWeight: '700', textAlign: 'center' },
  statusLabel: { color: colors.textFaint, fontSize: 12, fontWeight: '700', textAlign: 'center', marginTop: 4 },
  notice: { backgroundColor: '#030B14', borderRadius: 20, borderWidth: 1, borderColor: 'rgba(255,255,255,0.14)', padding: 15, marginBottom: 14 },
