...
const styles = StyleSheet.create({
  ...
  metricValue: { color: colors.orange, fontSize: 22, fontWeight: '600', marginBottom: 3 },
  metricNavy: { color: '#F8FAFC' },
  metricGreen: { color: '#8DE7B1' },
  metricSlate: { color: '#CBD5E1' },
  metricLabel: { color: '#9CA3AF', fontSize: 11, fontWeight: '600', lineHeight: 15 },
  ...
  heroTitle: { color: '#FFFFFF', fontSize: 23, fontWeight: '600', lineHeight: 28 },
  heroSub: { color: '#9CA3AF', fontSize: 13, fontWeight: '600', marginTop: 5 },
  ...
  statusBadgeText: { fontSize: 9, letterSpacing: 0, fontWeight: '600' },
  ...
  summaryValue: { color: '#FFFFFF', fontSize: 18, fontWeight: '600', textAlign: 'center' },
  summaryLabel: { color: '#CBD5E1', fontSize: 10.5, fontWeight: '600', textAlign: 'center', marginTop: 3 },
  ...
  dashboardFlyerFallbackText: { color: colors.orange, fontSize: 8.5, fontWeight: '600' },
  dashboardEventTitleBlock: { flex: 1 },
  dashboardEventTitle: { color: '#FFFFFF', fontSize: 16, lineHeight: 20, fontWeight: '600' },
  dashboardEventMeta: { color: '#9CA3AF', fontSize: 11.5, fontWeight: '600', marginTop: 4 },
  dashboardEventStats: { flexDirection: 'row', justifyContent: 'space-between', gap: 8, marginBottom: 8 },
  dashboardEventStat: { color: '#CBD5E1', fontSize: 11.5, fontWeight: '600' },
  dashboardEventPrice: { color: '#F97316', fontSize: 11, fontWeight: '600', marginTop: 3 },
  ...
  eventPillText: { fontSize: 8.5, letterSpacing: 0, fontWeight: '600' },
  ...
  buttonText: { color: '#FFFFFF', fontSize: 14, letterSpacing: 0, fontWeight: '600', textAlign: 'center' },
  ...
  cardTitle: { color: colors.textPrimary, fontSize: 26, fontWeight: '600', marginBottom: 8 },
  ...
  activityTitle: { color: colors.textPrimary, fontSize: 15, fontWeight: '600', marginBottom: 3 },
  activityCopy: { color: colors.textFaint, fontSize: 13, fontWeight: '600', lineHeight: 18 },
  ...
  pickerDoneText: { color: '#f97316', fontSize: 16, fontWeight: '600' },
  ...
  categoryPickerTitle: { color: '#F8FAFC', fontSize: 17, fontWeight: '600' },
  ...
  categoryOptionIconText: { color: '#F8FAFC', fontSize: 15, fontWeight: '600' },
  categoryOptionText: { flex: 1, color: 'rgba(226,232,240,0.84)', fontSize: 15, fontWeight: '600' },
  categoryOptionTextActive: { color: '#FFFFFF' },
  input: { minHeight: 56, borderRadius: 17, borderWidth: 1, borderColor: 'rgba(255,255,255,0.14)', backgroundColor: '#030B14', paddingHorizontal: 16, color: colors.textPrimary, fontSize: 16, fontWeight: '600' },
  ...
  mediaIconText: { color: colors.orange, fontSize: 11, fontWeight: '600' },
  mediaTitle: { color: colors.textPrimary, fontSize: 17, fontWeight: '600', marginBottom: 4 },
  mediaCopy: { color: colors.textFaint, fontSize: 13, fontWeight: '600', lineHeight: 18, marginBottom: 12 },
  ...
  mediaDeleteText: { color: '#ff5a45', fontSize: 12, fontWeight: '600', letterSpacing: 0.5 },
  mediaButtonText: { color: '#FFFFFF', fontSize: 14, letterSpacing: 0, fontWeight: '600' },
  ...
  noticeTitle: { color: colors.textPrimary, fontSize: 18, fontWeight: '600', marginBottom: 5 },
  noticeCopy: { color: colors.textFaint, fontSize: 13, lineHeight: 19, fontWeight: '600' },
  ...
  segmentText: { color: colors.textFaint, fontSize: 12, fontWeight: '600' },
  segmentTextActive: { color: '#FFFFFF' },

  // Focal / Banner slider
  focalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
  focalPct: { color: '#F97316', fontSize: 12, fontWeight: '600' },
  ...
  focalTickLabel: { color: 'rgba(148,163,184,0.6)', fontSize: 9, fontWeight: '600' },
  ...
  netCardLeft: { flex: 1 },
  netEyebrow: { color: '#8DE7B1', fontSize: 11, fontWeight: '600', letterSpacing: 0.5, marginBottom: 4 },
  netValue: { color: '#8DE7B1', fontSize: 26, fontWeight: '600', marginBottom: 3 },
  ...
  dayLabel: { color: '#CBD5E1', fontSize: 12, fontWeight: '600' },
  dayRevenue: { color: '#F97316', fontSize: 12, fontWeight: '600' },
  ...
  accessPct: { color: '#8DE7B1', fontSize: 36, fontWeight: '600', lineHeight: 40 },
  ...
  accessScannedVal: { color: '#8DE7B1', fontSize: 24, fontWeight: '600' },
  accessScannedLbl: { color: 'rgba(141,231,177,0.65)', fontSize: 9, fontWeight: '600', letterSpacing: 0.6, marginTop: 3 },
  ...
  accessPendingVal: { color: '#F97316', fontSize: 24, fontWeight: '600' },
  accessPendingLbl: { color: 'rgba(249,115,22,0.65)', fontSize: 9, fontWeight: '600', letterSpacing: 0.6, marginTop: 3 },
});
