...
const styles = StyleSheet.create({
  ...
  metricLabel: { color: colors.textFaint, fontSize: 12, fontWeight: '700', lineHeight: 17 },
  ...
  heroTitle: { color: '#FFFFFF', fontSize: 24, fontWeight: '700', lineHeight: 29 },
  ...
  summaryLabel: { color: '#cbd5e1', fontSize: 11, fontWeight: '700', textAlign: 'center', marginTop: 3 },
  ...
  input: { minHeight: 56, borderRadius: 17, borderWidth: 1, borderColor: colors.goldBorder, backgroundColor: colors.card, paddingHorizontal: 16, color: colors.textPrimary, fontSize: 16, fontWeight: '700' },
