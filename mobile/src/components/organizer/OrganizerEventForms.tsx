...
const styles = StyleSheet.create({
  ...
  metricNavy: { color: colors.textPrimary },
  metricGreen: { color: '#16a34a' },
  metricSlate: { color: colors.textFaint },
  metricLabel: { color: colors.textFaint, fontSize: 12, fontWeight: '900', lineHeight: 17 },
  ...
  statusDraftText: { color: colors.textFaint },
  ...
  card: { backgroundColor: colors.card, borderRadius: 26, borderWidth: 1, borderColor: colors.goldBorder, padding: 18, marginBottom: 16 },
  stepCard: { backgroundColor: colors.card, borderRadius: 28, borderWidth: 1, borderColor: colors.goldBorder, padding: 20, marginBottom: 16, shadowColor: '#111827', shadowOpacity: 0.07, shadowRadius: 18, shadowOffset: { width: 0, height: 10 } },
  cardTitle: { color: colors.textPrimary, fontSize: 26, fontWeight: '900', marginBottom: 8 },
  ...
  activityTitle: { color: colors.textPrimary, fontSize: 15, fontWeight: '900', marginBottom: 3 },
  activityCopy: { color: colors.textFaint, fontSize: 13, fontWeight: '700', lineHeight: 18 },
  field: { marginBottom: 14 },
  fieldCompact: { flex: 1 },
  fieldLabel: { color: colors.textFaint, fontSize: 12, letterSpacing: 1.4, fontWeight: '400', textTransform: 'uppercase', marginBottom: 8 },
  input: { minHeight: 56, borderRadius: 17, borderWidth: 1, borderColor: colors.goldBorder, backgroundColor: colors.card, paddingHorizontal: 16, color: colors.textPrimary, fontSize: 16, fontWeight: '800' },
  textArea: { minHeight: 96, paddingTop: 14, textAlignVertical: 'top' },
  twoCol: { flexDirection: 'row', gap: 12 },
  mediaGrid: { gap: 12, marginBottom: 14 },
  mediaBox: { backgroundColor: colors.cardSoft, borderRadius: 20, borderWidth: 1, borderColor: colors.goldBorder, padding: 16 },
  ...
  mediaTitle: { color: colors.textPrimary, fontSize: 17, fontWeight: '900', marginBottom: 4 },
  ...
  noticeTitle: { color: colors.textPrimary, fontSize: 18, fontWeight: '900', marginBottom: 5 },
  ...
  segmentText: { color: colors.textFaint, fontSize: 12, fontWeight: '900' },
