...
const styles = StyleSheet.create({
  ...
  eventTitle: { color: colors.textPrimary, fontSize: 21, fontWeight: '700', lineHeight: 26, marginBottom: 5 },
  eventMeta: { color: colors.textFaint, fontSize: 13, lineHeight: 19, fontWeight: '400' },
  statsRow: { flexDirection: 'row', gap: 10, marginBottom: 14 },
  miniStat: { flex: 1, backgroundColor: colors.cardSoft, borderRadius: 17, padding: 12, borderWidth: 1, borderColor: colors.goldBorder },
  miniValue: { color: colors.textPrimary, fontSize: 16, fontWeight: '700', textAlign: 'center' },
  miniLabel: { color: colors.textFaint, fontSize: 11, fontWeight: '400', textAlign: 'center', marginTop: 3 },
  ...
  actionTextMuted: { color: colors.textPrimary },
  publishButton: {
    height: 46,
    borderRadius: 15,
  ...
  publishText: { color: '#FFFFFF', fontSize: 14, letterSpacing: 0, fontWeight: '700' },
});
