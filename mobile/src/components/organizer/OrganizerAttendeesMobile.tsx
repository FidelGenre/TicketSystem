...
const styles = StyleSheet.create({
  ...
  avatarText: { color: '#F8FAFC', fontSize: 14, fontWeight: '600' },
  buyerMain: { flex: 1, minWidth: 0 },
  buyerName: { color: '#F8FAFC', fontSize: 15, fontWeight: '600' },
  ...
  smallBtnText: { color: '#FFFFFF', fontSize: 9, fontWeight: '600' },
  ...
  btnText: { color: '#FFFFFF', fontSize: 11, fontWeight: '600' },
  ...
  modalTitle: { color: '#F8FAFC', fontSize: 18, fontWeight: '600' },
  modalSection: { gap: 8 },
  switchRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  modalLabel: { color: '#F8FAFC', fontSize: 14, fontWeight: '600' },
