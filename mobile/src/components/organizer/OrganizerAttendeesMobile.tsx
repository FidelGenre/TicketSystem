...
const styles = StyleSheet.create({
  ...
  searchIcon: { color: colors.textPrimary, fontSize: 22, fontWeight: '700' },
  searchText: { color: '#9CA3AF', fontSize: 14, fontWeight: '700' },
  attendeeCard: {
    backgroundColor: colors.card,
    borderRadius: 22,
    borderWidth: 1,
  ...
  attendeeMain: { flex: 1 },
  name: { color: colors.textPrimary, fontSize: 17, fontWeight: '700', marginBottom: 3 },
  email: { color: colors.textFaint, fontSize: 12, fontWeight: '400', marginBottom: 4 },
  ticket: { color: '#111827', fontSize: 13, fontWeight: '700' },
  ...
  codeLabel: { color: '#9CA3AF', fontSize: 10, letterSpacing: 0, fontWeight: '700', marginBottom: 4 },
  codeValue: { color: colors.textPrimary, fontSize: 13, fontWeight: '700' },
