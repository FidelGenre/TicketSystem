    ...
    <div className="event-signature-card group relative">
      <Link href={`/events/${event.slug}`} className="block">
        ...
        <div className="space-y-3 p-4">
          ...
          <div className="flex items-center justify-between border-t border-gray-100 pt-3">
            ...
            <span className="inline-flex h-11 w-[9.25rem] items-center justify-center rounded-lg bg-primary-500 text-[10px] font-black uppercase tracking-[0.1em] text-white transition-all group-hover:bg-primary-600">
              Tickets
            </span>
          </div>
        </div>
      ...
      <div className="absolute right-4 bottom-[6.15rem] z-20">
        <ShareEventButton
          ...
          compact
          className="shrink-0 !h-11 !w-[9.25rem] !rounded-lg !border-blue-800 !bg-blue-800 !text-white !shadow-none hover:!bg-blue-700"
        />
      </div>
    </div>
  );
